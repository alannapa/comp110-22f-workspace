...
class Pizza:
    ...
    # Constructor function call to initialize the attributes of a function
...
# Method Call - the price function is a part of the Pizza class
# When memory diagramming, Pizza#price - class # method call
